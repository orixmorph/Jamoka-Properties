...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    contactPage: {
      ...
      hoursText: 'Monday to Friday: 10:00am – 6:00pm | Saturday: 10:00am – 2:00pm',
  ...
  ar: {
    ...
    contactPage: {
      ...
      hoursText: 'من الإثنين إلى الجمعة: 10:00 صباحاً – 6:00 مساءً | السبت: 10:00 صباحاً – 2:00 ظهراً',
