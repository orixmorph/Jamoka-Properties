...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    projects: {
      ...
      downloadBrochure: 'Download Official Brochure',
      amenities: 'Key Amenities & Features',
      milestones: 'Payment Milestones',
      brochurePrompt: 'Enter your contact details below to receive the complete master brochure, floor plans, and unit pricing.',
      brochureSuccessTitle: 'Brochure Sent Successfully!',
      brochureSuccessDesc: 'The complete PDF brochure and pricing dossier has been prepared and sent to your email and WhatsApp.',
      namePlaceholder: 'Full Name',
      emailPlaceholder: 'Email Address',
      phonePlaceholder: 'Phone / WhatsApp (+Country Code)',
      closeModal: 'Close',
    },
    wheel: {
    ...
    contactPage: {
      ...
      message: 'Message or Project Inquiry',
      ...
      officeAddress: 'Bayswater Tower, Office 807, Business Bay, Dubai, UAE',
  ...
  ar: {
    ...
    projects: {
      ...
      requestBrochure: 'تحميل الكتيب',
      downloadBrochure: 'تحميل الكتيب الرسمي والمخططات',
      amenities: 'أبرز المزايا والمرافق',
      milestones: 'مراحل خطة السداد',
      brochurePrompt: 'أدخل بياناتك أدناه لتحميل الكتيب الرسمي ومخططات الطوابق وقائمة الأسعار فوراً.',
      brochureSuccessTitle: 'تم إرسال الكتيب بنجاح!',
      brochureSuccessDesc: 'تم تجهيز ملف الكتيب والمخططات وإرساله إلى بريدك الإلكتروني والواتساب.',
      namePlaceholder: 'الاسم الكامل',
      emailPlaceholder: 'البريد الإلكتروني',
      phonePlaceholder: 'رقم الهاتف / الواتساب (+رمز الدولة)',
      closeModal: 'إغلاق',
    },
    wheel: {
    ...
    contactPage: {
      ...
      officeAddress: 'برج بايزووتر، مكتب 807، الخليج التجاري، دبي، الإمارات',
