      ...
      <div className="bg-white rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.06)] border border-neutral-200/90 p-6 sm:p-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 pb-6 border-b border-neutral-100">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#0F172A] text-[#D4AF37] flex items-center justify-center">
              <SlidersHorizontal className="w-5 h-5" />
            </div>
            <div>
              <h3 className="text-lg font-bold text-slate-900 tracking-tight flex items-center gap-2">
                Off-Plan Portfolio Alignment Engine
                <span className="inline-flex items-center gap-1 text-[10px] font-extrabold bg-[#FAF5EC] text-[#A6833D] px-2 py-0.5 rounded-full border border-[#D4AF37]/30">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div>
            <label className="text-xs font-bold text-slate-700 uppercase tracking-wider mb-2 flex items-center gap-1.5">
              <MapPin className="w-3.5 h-3.5 text-[#D4AF37]" /> Target Enclave
            </label>
            <select
              value={filters.enclave}
              onChange={(e) => onFilterChange('enclave', e.target.value)}
              className="w-full bg-neutral-50 hover:bg-neutral-100 border border-neutral-200 rounded-xl px-3.5 py-2.5 text-xs font-semibold text-slate-800 focus:outline-none focus:border-[#D4AF37] transition-colors cursor-pointer"
            >
              {enclaves.map((e) => (
          ...
          <div>
            <label className="text-xs font-bold text-slate-700 uppercase tracking-wider mb-2 flex items-center gap-1.5">
              <CreditCard className="w-3.5 h-3.5 text-[#D4AF37]" /> Payment Framework
            </label>
            <select
          ...
          <div>
            <label className="text-xs font-bold text-slate-700 uppercase tracking-wider mb-2 flex items-center gap-1.5">
              <DollarSign className="w-3.5 h-3.5 text-[#D4AF37]" /> Investment Bracket
            </label>
            <select
          ...
          <div>
            <label className="text-xs font-bold text-slate-700 uppercase tracking-wider mb-2 flex items-center gap-1.5">
              <Calendar className="w-3.5 h-3.5 text-[#D4AF37]" /> Completion Horizon
            </label>
            <select
